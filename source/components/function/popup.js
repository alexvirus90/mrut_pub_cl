...
export default function Popup(obj){
	...
	let speed = (obj.speed === null) ? 0 : obj.speed;
	 ...
	 popup = "<div class='header1 clearfix'><div class='actions'>" +
		...
		"</use></svg>Соединение: <strong class='lastGSMConnectionTime nobr'> "+ obj.time +"</strong></li>" +
		...
		"</use></svg>Питание</li></ul></div><!--/features-->" +
		"</div><!--/row-fluid-->" +
		"<div class='rid-progress-wrap'>" +
		"<div class='rid-progress nobr ' style='width:380px'>" +
		"Выполнение с/з: <span class='localRID'>40678</span>" +
		"(<span class='rid-percent'>100</span>%)" +
		"</div>" +
		"</div>" +
		"<div class='cent'>" +
